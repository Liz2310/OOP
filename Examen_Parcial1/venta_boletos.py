...
class Venta_Boleto(Venta):
    """Subclase que se enfoca en la venta de boletos, cambia la funcion de Precio_Total de
    acuerdo con la cantidad de boletos vendidos y el precio de un solo boleto """
