# Contains notebook and note objects
import datetime
...
class Note:
    ...
    def __init__(self, memo, tags=""):
        """Initialize a note with a memo and an optional space-separated tags.
    ...
    def match(self, filter):
        """Determine if this note matches the filter text.
           ...
           Search is case sensitive and matches both txt and tags."""
